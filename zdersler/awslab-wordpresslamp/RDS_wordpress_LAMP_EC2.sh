...
# 22. Go to the "cd /var/www/html/" to secure config file before change

cd /var/www/html/
sudo cp wp-config-sample.php wp-config.php

# 23. Change the config file for database assosiation
...
# 24. Check the browser. You'll see the home page of Wordpress
      # enter pasword,user name etc... 

# 25. Login databse again for upload an tables 
mysql -u admin -p

# 26. Show databases and Select the database "clarusway"
SHOW DATABASES;
USE clarusway;

# 27. Create a table named "store" 
...
# 28. Insert some data into the table named "store"
...
# 29. Create a table named "Client"
...
# 30. Insert some data into the table named "client"
