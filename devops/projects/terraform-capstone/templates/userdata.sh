...
sed -i "s/'database name in RDS is written here'/'clarusway'/g" settings.py
sed -i "s/'database master username in RDS is written here'/'clarusway'/g" settings.py
sed -i "s/'database endpoint is written here'/'${rds_endpoint}'/g" settings.py
